...
export default function Chatbot() {
  ...
  return (  
    <main
      ref={ref}
      className="relative flex flex-col  max-w-[60vw] h-[30vw] overflow-auto bg-transparent rounded-lg p-4 shadow bg-gradient-to-r from-gray-600 to-gray-900 text-white rounded-lg shadow-xl p-6 w-full"
    >
